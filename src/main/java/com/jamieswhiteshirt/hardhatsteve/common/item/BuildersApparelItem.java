...
public class BuildersApparelItem extends DyeableArmorItem {
    ...
    public Multimap<String, EntityAttributeModifier> getModifiers(EquipmentSlot equipmentSlot_1) {
        ...
        if (equipmentSlot_1 == this.slot) {
            multimap_1.put(HardHatSteveEntityAttributes.REACH.getId(), new EntityAttributeModifier(MODIFIERS[equipmentSlot_1.getEntitySlotId()], "Reach modifier", 0.5D, EntityAttributeModifier.Operation.ADDITION));
        }
